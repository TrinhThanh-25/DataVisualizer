...
AVLState::AVLState(): createBox(120,680,AVLBoxSize.x, AVLBoxSize.y,AVLBoxFontSize,boxColor, boxTextColor), valueBox(120,680,AVLBoxSize.x, AVLBoxSize.y,AVLBoxFontSize,boxColor, boxTextColor){
