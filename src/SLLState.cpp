...
SLLState::SLLState(): createBox(120,680,SLLBoxSize.x, SLLBoxSize.y,SLLBoxFontSize,SLLBoxColor, SLLBoxTextColor), indexBox(120,680,SLLBoxSize.x, SLLBoxSize.y,SLLBoxFontSize,SLLBoxColor, SLLBoxTextColor), valueBox(120,790,SLLBoxSize.x, SLLBoxSize.y,SLLBoxFontSize,SLLBoxColor, SLLBoxTextColor){
...
void SLLState::update(){
    ...
    if(panel.isCreateUsed()){
        ...
        this->Apply.setPosition({250,810});
        ...
        this->Apply.setPosition({250,740});
        valueBox.setPosition({120,680});
        Front.deActive();
        End.deActive();
        Random.deActive();
