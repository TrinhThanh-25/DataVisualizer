...
ShortestPathState::ShortestPathState() : NodesBox(120,680,STBoxSize.x,STBoxSize.y,STBoxFontSize,boxColor,boxTextColor), EdgesBox(120,750,STBoxSize.x,STBoxSize.y,STBoxFontSize,boxColor,boxTextColor), StartNodesBox(120,680,STBoxSize.x,STBoxSize.y,STBoxFontSize,boxColor,boxTextColor){
